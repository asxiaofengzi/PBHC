...
def main() -> None:
    ...
    humanoid_xml = '/home/js/xiaofengzi/PBHC/description/robots/g1/g1_23dof_lock_wrist_fitmotionONLY.xml'
    ...
    motion_file = '/home/js/xiaofengzi/PBHC/smpl_retarget/retargeted_motion_data/mink/B1 - stand to walk_poses.pkl'
    print(motion_file)
